        ...
        function getPrice1() {
			...
			if (frmRestaurant.chkItem1.checked == true) {
				...
				isSelected = 1;
                var q1=document.getElementById("quan").value
                billAmount += num1 * q1;
            } else {
...
var bg_image = new Array("url('rest.jpg')", "url('rest1.jpg')",
    "url('rest3.jpg')", "url('rest4.jpg')", "url('rest5.jpg')",
    "url('rest6.jpg')", "url('rest7.jpg')", "url('rest8.jpg')");
