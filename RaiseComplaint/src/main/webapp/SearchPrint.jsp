<%@page import="Mphasis.RaiseComplaint.ConnectionHelper"%><%@page import="java.sql.ResultSet"%>
...
<body>
	...
	<%
		...
		if(searchtype.equals("id")) sql = " SELECT * FROM Complaint WHERE Id = ? " ;
		else if(searchtype.equals("date")) sql = " SELECT * FROM Complaint WHERE date = ? " ;
		else if(searchtype.equals("dept")) sql = " SELECT * FROM Complaint WHERE Dept = ? " ;
		else sql = " SELECT * FROM Complaint WHERE Name != ? OR 1 = 1 " ;
