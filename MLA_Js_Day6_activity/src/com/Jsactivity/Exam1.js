...
function load()
{
    ...
    if (BG == 0) { document.body.background = "1.png"; }
    else if (BG == 1) { document.body.background = "2.png"; }
    else if (BG == 2) { document.body.background = "3.png"; }
    else { document.body.background = "1.png"; }
	LoadQuestion();
}
